    ...
    if ( f != NULL )
      ...
      if ( seq != NULL )
        ...
        while ( sqItem )
          ...
          std::cout << "Radiopharmaceutical Start Time = " << tag << std::endl;
        ...
        std::cout << "Radionuclide Total Dose = " << tag << std::endl;
          if ( tag.c_str() == NULL || *(tag.c_str()) == '\0' )
            {
          ...
          std::cout << "RadionuclideHalfLife = " << tag << std::endl;
        ...
        std::cout << "DecayCorrection = " << tag << std::endl;
        if ( tag.c_str() != NULL && strcmp(tag.c_str(), "" ) )
          {
...
//            this->Day = 0;
        ...
        std::cout << "PatientName = " << tag << std::endl;
        if ( tag.c_str() != NULL && strcmp (tag.c_str(), "" ) )
          {
        ...
        std::cout << "DecayFactor = " << tag << std::endl;
        if ( tag.c_str() != NULL && strcmp(tag.c_str(), "" ) )
          {
        ...
        std::cout << "FrameReferenceTime = " << tag << std::endl;
        if ( tag.c_str() != NULL && strcmp(tag.c_str(), "" ) )
          {
        ...
        std::cout << "SeriesTime = " << tag << std::endl;
        if ( tag.c_str() != NULL && strcmp(tag.c_str(), "" ) )
          {
          hourstr.clear();
          minutestr.clear();
        ...
        std::cout << "PatientWeight = " << tag << std::endl;
        if ( tag.c_str() != NULL && strcmp(tag.c_str(), "" ) )
          {
        ...
        std::cout << "CalibrationFactor = " << tag << std::endl;
        if ( tag.c_str() != NULL && strcmp(tag.c_str(), "" ) )
          {
  ...
  for( int i = lo; i <= hi; i++ )
    ...
    if( voxNumber > 0 )
      ...
      if( dose == 0.0 )
        ...
        if (list.SUVVolumeName.length() != 0)
        {
          ...
          while (!it.IsAtEnd())
          {
            ...
            it.Set(current);//it.Get() * (InputPixelType) tissueConversionFactor * (InputPixelType) weightByDose);
            ++it;
          }
